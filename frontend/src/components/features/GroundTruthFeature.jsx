...
function GroundTruthFeature() {
    ...
    const handleCompare = async (e) => {
        ...
        try {
            ...
            setResult(data.final_response || "No comparison generated.");
        } catch (err) {
    ...
    const handleQuery = async (e) => {
        ...
        try {
            ...
            setResult(data.final_response || "No answer found.");
        } catch (err) {
    ...
    return (
        <div className="feature-card">
            ...
            <div className="sub-tabs">
                <button onClick={() => { setResult(''); setError(''); setMode('compare'); }} className={mode === 'compare' ? 'active' : ''}>Direct Comparison</button>
                <button onClick={() => { setResult(''); setError(''); setMode('query'); }} className={mode === 'query' ? 'active' : ''}>Knowledge Base Query</button>
            </div>
